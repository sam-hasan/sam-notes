...
export const BOOK_CREATE_COMMENT_REQUEST = 'BOOK_CREATE_COMMENT_REQUEST';
export const BOOK_CREATE_COMMENT_SUCCESS = 'BOOK_CREATE_COMMENT_SUCCESS';
export const BOOK_CREATE_COMMENT_FAIL = 'BOOK_CREATE_COMMENT_FAIL';
export const BOOK_CREATE_COMMENT_RESET = 'BOOK_CREATE_COMMENT_RESET';
